...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 font-notosans font-semibold",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-7 px-3",
        lg: "h-9 px-5",
        prev: "rounded-none w-14 h-12 rounded-l-xl",
        next: "rounded-none w-14 h-12 rounded-r-xl",
